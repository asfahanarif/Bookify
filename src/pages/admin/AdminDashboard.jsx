        ...
        <div className="mid mb-5">
          ...
          <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
            ...
            <div className="flex justify-center mt-5">
              <button
                type="button"
                className="text-white bg-pink-500 hover:bg-pink-600 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  "
              >
                {user && (
            ...
            <h2 className="text-center text-2xl font-bold text-black-500 mt-5">
              Back to{" "}
              <Link
                className=" text-center text-2xl font-bold text-pink-500"
                to={"/"}
              >
                Home
              </Link>
